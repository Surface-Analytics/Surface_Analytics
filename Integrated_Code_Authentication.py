...
if not st.session_state.authenticated:
    st.title("Welcome to REXA")

    auth_choice = st.radio("Choose an option", ["Login", "Register"])
    # auth_choice = st.radio("Choose an option", ["Login"])    
...
# Main App Logic (Only visible after login)
if st.session_state.authenticated:
    st.sidebar.subheader(f"Hi, {st.session_state.username}!")
